...
export const columns = ({ openModal, openDeleteAlert }: ColumnsConfig): ColumnDef<StudentWithId>[] => {
  const CopyIdButton = ({ studentId }: { studentId: string }) => {
      ...
      return <DropdownMenuItem onClick={handleCopy}>Copy student ID</DropdownMenuItem>
  }
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <CopyIdButton studentId={student.id} />
              <DropdownMenuSeparator />
